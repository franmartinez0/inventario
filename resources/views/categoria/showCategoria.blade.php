<x-mi-layout>
    ...
    <a
        ...
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $categoria->nombre }}</h5>
        <p class="font-normal text-gray-700 dark:text-gray-400">Codigo: {{ $categoria->id }}</p>
