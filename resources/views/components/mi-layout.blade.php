    ...
    <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div>
            <form class="max-w-md mx-auto relative">
                <div id="dropdown"
                    class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute top-14 left-0 hidden">
                ...
                <div class="relative">
                    ...
                    <form action="{{ route('productos.buscar') }}" method="POST">
                        <input type="search" id="default-search" name="busqueda"
                            class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="busca por modelo o por código " required />
                        <button type="submit"
